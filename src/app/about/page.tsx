        ...
        <CardContent className="space-y-6">
          <div>
            ...
            <p className="text-muted-foreground">
              「Townfolk Tales」は、AI（人工知能）によって命を吹き込まれた、個性豊かな町の住人たちとの会話を楽しむことができる、新しい形のインタラクティブな体験を提供するアプリケーションです。
            </p>
          </div>
          <div>
            <h2 className="text-lg font-semibold mb-2">このアプリで出来ること</h2>
            <p className="text-muted-foreground">
              パン屋、警備隊長、魔法使いなど、様々な背景を持つキャラクターたちと自由に会話できます。あなたの言葉が、彼らの機嫌やあなたへの感情を変化させ、会話の展開に影響を与えます。時には徳を積んでポイントを獲得することもあるでしょう。
            </p>
          </div>
           <div>
