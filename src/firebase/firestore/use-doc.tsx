...
import type { useMemoFirebase } from '../provider';
...
export function useDoc<T = any>(
  ...
  if (memoizedDocRef && !memoizedDocRef.__memo) {
    throw new Error(`Document reference for path ${memoizedDocRef.path} was not properly memoized using useMemoFirebase`);
  }
